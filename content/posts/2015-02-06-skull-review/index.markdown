...
[Skull](https://amzn.to/47zdfRR)* not only is a game I would definitely bring to my family, Skull caught my eye because of its appeal to being both an opener to a night of games, and as a fun, easy activity to close out a night.
...
{{< figure
    src="hand.jpg"
    alt="A hand of three flowers, and a skull with matching square."
    caption="A hand of three flowers, and a skull with matching square."
    >}}
...
{{< figure
    src="playing-disc.jpg"
    alt="Playing a disc on the square. We usually offset each disc to make them easier to see."
    caption="Playing a disc on the square. We usually offset each disc to make them easier to see."
    >}}
...
{{< figure
    src="fatcatnyc.jpg"
    alt="Running into a Skull at a bar, using a deck of cards. (We used red cards for flowers, and black for skulls)"
    caption="Running into a Skull at a bar, using a deck of cards. (We used red cards for flowers, and black for skulls)"
    >}}
...
{{< figure
    src="over-desert.jpg"
    alt="Playing Skull over desert"
    caption="Playing Skull over desert"
    >}}
...
[Skull is available on Amazon via this affiliate link](https://amzn.to/47zdfRR)

---

*Skull was formerly named Skull & Roses.*

*This was originally posted on one of my othes websites.*